...
public class GerenciarProdutos extends JFrame {
	...
	static JLabel lblIdPr = new JLabel("Id Proudtor");
	static JLabel lblNomePr = new JLabel("Nome do Prudo");
	...
	public static void main(String[] args) {
		...
		///////////////////////////////////////////////////
		lblIdPr.setBounds(500, 10, 150, 30);
		gerenciar.add(lblIdPr);
		
		txtIdPr.setBounds(500, 35, 150, 30);
		gerenciar.add(txtIdPr);
		
		lblNomePr.setBounds(500, 75, 150, 30);
		gerenciar.add(lblNomePr);
		
		txtNomePr.setBounds(500, 105, 150, 30);
		gerenciar.add(txtNomePr);
		
		lblDescPr.setBounds(500, 145, 150, 30);
		gerenciar.add(lblDescPr);
		
		txtDescPr.setBounds(500, 180, 415, 65);
		gerenciar.add(txtDescPr);
		
		lblCategoria.setBounds(500, 245, 150, 30);
		gerenciar.add(lblCategoria);
		
		txtCategoria.setBounds(500, 275, 150, 30);
		gerenciar.add(txtCategoria);
		
		lblFornecedor.setBounds(500, 310, 150, 30);
		gerenciar.add(lblFornecedor);
		
		txtFornecedor.setBounds(500, 345, 150, 30);
		gerenciar.add(txtFornecedor);
		
		lblPrecoPr.setBounds(500, 375, 100, 30);
		gerenciar.add(lblPrecoPr);
		
		txtPrecoPr.setBounds(500, 410, 150, 30);
		gerenciar.add(txtPrecoPr);
		
		btnCadPr.setBounds(500, 445, 200, 30);
		gerenciar.add(btnCadPr);
		
		
		///////////////////////////////////////////////////////
		//Desabilitar os controles textfield do fornoecedor e produtos 
		...
		btnCadCat.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				///////////desabilitar as caixas de gategoria
		...
		//-----Vamos instanciar a classe fornecedor e passar os dados para o objeto no monmento em que o botão de cadastro for clicado
		...
		btnCadFor.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// Vamos criar um objeto baseado em produtos para passar os dados no momento do lcicque do botão cadastro
